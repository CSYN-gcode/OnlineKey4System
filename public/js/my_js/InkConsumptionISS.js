function GetCurrentFYInkDataISS() {
    $.ajax({
        url: 'get_current_ink_data_iss',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkISS').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-iss-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-iss-actual-target').html(aprilDifference);
                        
                        $('.april-ink-iss-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-iss-tricolor').html('-');
                        $('.april-ink-iss-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-iss-actual-target').html('-');
                    $('.april-ink-iss-current-fy-target').html('-');
                    $('.april-ink-iss-current-fy-actual').html('-');
                }
            } else {
            ...
            if(jQuery.inArray(5, datas) != -1) {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-iss-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-iss-actual-target').html(mayDifference);
                        $('.may-ink-iss-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-iss-tricolor').html('-');
                        $('.may-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.may-ink-iss-actual-target').html('-');
                $('.may-ink-iss-tricolor').html('-');
                $('.may-ink-iss-current-fy-target').html('-');
                $('.may-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-iss-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-iss-actual-target').html(juneDifference);
                        $('.june-ink-iss-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-iss-tricolor').html('-');
                        $('.june-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-iss-actual-target').html('-');
                $('.june-ink-iss-tricolor').html('-');
                $('.june-ink-iss-current-fy-target').html('-');
                $('.june-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-iss-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-iss-actual-target').html(julyDifference);
                        $('.july-ink-iss-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-iss-tricolor').html('-');
                        $('.july-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-iss-actual-target').html('-');
                $('.july-ink-iss-tricolor').html('-');
                $('.july-ink-iss-current-fy-target').html('-');
                $('.july-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-iss-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-iss-actual-target').html(augustDifference);
                        $('.august-ink-iss-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-iss-tricolor').html('-');
                        $('.august-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-iss-actual-target').html('-');
                $('.august-ink-iss-tricolor').html('-');
                $('.august-ink-iss-current-fy-target').html('-');
                $('.august-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-iss-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-iss-actual-target').html(septemberDifference);
                        $('.september-ink-iss-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-iss-tricolor').html('-');
                        $('.september-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-iss-actual-target').html('-');
                $('.september-ink-iss-tricolor').html('-');
                $('.september-ink-iss-current-fy-target').html('-');
                $('.september-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-iss-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-iss-actual-target').html(octoberDifference);
                        $('.october-ink-iss-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-iss-tricolor').html('-');
                        $('.october-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-iss-actual-target').html('-');
                $('.october-ink-iss-tricolor').html('-');
                $('.october-ink-iss-current-fy-target').html('-');
                $('.october-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-iss-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-iss-actual-target').html(novemberDifference);
                        $('.november-ink-iss-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-iss-tricolor').html('-');
                        $('.november-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-iss-actual-target').html('-');
                $('.november-ink-iss-tricolor').html('-');
                $('.november-ink-iss-current-fy-target').html('-');
                $('.november-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-iss-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-iss-actual-target').html(decemberDifference);
                        $('.december-ink-iss-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-iss-tricolor').html('-');
                        $('.december-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-iss-actual-target').html('-');
                $('.december-ink-iss-tricolor').html('-');
                $('.december-ink-iss-current-fy-target').html('-');
                $('.december-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-iss-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-iss-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-iss-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-iss-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-iss-tricolor').html('-');
                        $('.january-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-iss-actual-target').html('-');
                $('.january-ink-iss-tricolor').html('-');
                $('.january-ink-iss-current-fy-target').html('-');
                $('.january-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-iss-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-iss-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-iss-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-iss-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-iss-tricolor').html('-');
                        $('.february-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-iss-actual-target').html('-');
                $('.february-ink-iss-tricolor').html('-');
                $('.february-ink-iss-current-fy-target').html('-');
                $('.february-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-iss-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-iss-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-iss-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-iss-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-iss-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-iss-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-iss-tricolor').html('-');
                        $('.march-ink-iss-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-iss-actual-target').html('-');
                $('.march-ink-iss-tricolor').html('-');
                $('.march-ink-iss-current-fy-target').html('-');
                $('.march-ink-iss-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-iss-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-iss-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-iss-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-iss-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-iss-actual-target').html(difference);
            $('.total-ink-iss-tricolor').html(difference);
        } else {
            $('.total-ink-iss-actual-target').html('-');
            $('.total-ink-iss-tricolor').html('-');
            
        }

            $('.april-ink-iss-current-fy').html('April ' + currentYear);
            $('.may-ink-iss-current-fy').html('May ' + currentYear);
            $('.june-ink-iss-current-fy').html('June ' + currentYear);
            $('.july-ink-iss-current-fy').html('July ' + currentYear);
            $('.august-ink-iss-current-fy').html('August ' + currentYear);
            $('.september-ink-iss-current-fy').html('September ' + currentYear);
            $('.october-ink-iss-current-fy').html('October ' + currentYear);
            $('.november-ink-iss-current-fy').html('November ' + currentYear);
            $('.december-ink-iss-current-fy').html('December ' + currentYear);
            $('.january-ink-iss-current-fy').html('January ' + nextYear);
            $('.february-ink-iss-current-fy').html('February ' + nextYear);
            $('.march-ink-iss-current-fy').html('March ' + nextYear); 
        }
    });
}