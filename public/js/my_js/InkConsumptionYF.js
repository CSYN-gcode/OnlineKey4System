function GetCurrentFYInkDataYF() {
    $.ajax({
        url: 'get_current_ink_data_yf',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkYF').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-yf-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-yf-actual-target').html(aprilDifference);
                        
                        $('.april-ink-yf-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-yf-tricolor').html('-');
                        $('.april-ink-yf-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-yf-actual-target').html('-');
                    $('.april-ink-yf-current-fy-target').html('-');
                    $('.april-ink-yf-current-fy-actual').html('-');
                }
            } else {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-yf-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-yf-actual-target').html(mayDifference);
                        $('.may-ink-yf-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-yf-tricolor').html('-');
                        $('.may-ink-yf-current-fy-actual').html('-');
                     }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-yf-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-yf-actual-target').html(juneDifference);
                        $('.june-ink-yf-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-yf-tricolor').html('-');
                        $('.june-ink-yf-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-yf-actual-target').html('-');
                $('.june-ink-yf-tricolor').html('-');
                $('.june-ink-yf-current-fy-target').html('-');
                $('.june-ink-yf-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-yf-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-yf-actual-target').html(julyDifference);
                        $('.july-ink-yf-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-yf-tricolor').html('-');
                        $('.july-ink-yf-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-yf-actual-target').html('-');
                $('.july-ink-yf-tricolor').html('-');
                $('.july-ink-yf-current-fy-target').html('-');
                $('.july-ink-yf-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-yf-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-yf-actual-target').html(augustDifference);
                        $('.august-ink-yf-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-yf-tricolor').html('-');
                        $('.august-ink-yf-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-yf-actual-target').html('-');
                $('.august-ink-yf-tricolor').html('-');
                $('.august-ink-yf-current-fy-target').html('-');
                $('.august-ink-yf-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-yf-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-yf-actual-target').html(septemberDifference);
                        $('.september-ink-yf-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-yf-tricolor').html('-');
                        $('.september-ink-yf-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-yf-actual-target').html('-');
                $('.september-ink-yf-tricolor').html('-');
                $('.september-ink-yf-current-fy-target').html('-');
                $('.september-ink-yf-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-yf-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-yf-actual-target').html(octoberDifference);
                        $('.october-ink-yf-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-yf-tricolor').html('-');
                        $('.october-ink-yf-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-yf-actual-target').html('-');
                $('.october-ink-yf-tricolor').html('-');
                $('.october-ink-yf-current-fy-target').html('-');
                $('.october-ink-yf-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-yf-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-yf-actual-target').html(novemberDifference);
                        $('.november-ink-yf-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-yf-tricolor').html('-');
                        $('.november-ink-yf-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-yf-actual-target').html('-');
                $('.november-ink-yf-tricolor').html('-');
                $('.november-ink-yf-current-fy-target').html('-');
                $('.november-ink-yf-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-yf-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-yf-actual-target').html(decemberDifference);
                        $('.december-ink-yf-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-yf-tricolor').html('-');
                        $('.december-ink-yf-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-yf-actual-target').html('-');
                $('.december-ink-yf-tricolor').html('-');
                $('.december-ink-yf-current-fy-target').html('-');
                $('.december-ink-yf-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-yf-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-yf-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-yf-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-yf-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-yf-tricolor').html('-');
                        $('.january-ink-yf-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-yf-actual-target').html('-');
                $('.january-ink-yf-tricolor').html('-');
                $('.january-ink-yf-current-fy-target').html('-');
                $('.january-ink-yf-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-yf-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-yf-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-yf-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-yf-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-yf-tricolor').html('-');
                        $('.february-ink-yf-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-yf-actual-target').html('-');
                $('.february-ink-yf-tricolor').html('-');
                $('.february-ink-yf-current-fy-target').html('-');
                $('.february-ink-yf-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-yf-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-yf-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-yf-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-yf-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-yf-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-yf-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-yf-tricolor').html('-');
                        $('.march-ink-yf-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-yf-actual-target').html('-');
                $('.march-ink-yf-tricolor').html('-');
                $('.march-ink-yf-current-fy-target').html('-');
                $('.march-ink-yf-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-yf-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-yf-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-yf-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-yf-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-yf-actual-target').html(difference);
            $('.total-ink-yf-tricolor').html(difference);
        } else {
            $('.total-ink-yf-actual-target').html('-');
            $('.total-ink-yf-tricolor').html('-');
            
        }

            $('.april-ink-yf-current-fy').html('April ' + currentYear);
            $('.may-ink-yf-current-fy').html('May ' + currentYear);
            $('.june-ink-yf-current-fy').html('June ' + currentYear);
            $('.july-ink-yf-current-fy').html('July ' + currentYear);
            $('.august-ink-yf-current-fy').html('August ' + currentYear);
            $('.september-ink-yf-current-fy').html('September ' + currentYear);
            $('.october-ink-yf-current-fy').html('October ' + currentYear);
            $('.november-ink-yf-current-fy').html('November ' + currentYear);
            $('.december-ink-yf-current-fy').html('December ' + currentYear);
            $('.january-ink-yf-current-fy').html('January ' + nextYear);
            $('.february-ink-yf-current-fy').html('February ' + nextYear);
            $('.march-ink-yf-current-fy').html('March ' + nextYear); 
        }
    });
}