function GetCurrentFYInkDataFIN() {
    $.ajax({
        url: 'get_current_ink_data_fin',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkFIN').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-fin-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-fin-actual-target').html(aprilDifference);
                        
                        $('.april-ink-fin-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-fin-tricolor').html('-');
                        $('.april-ink-fin-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-fin-actual-target').html('-');
                    $('.april-ink-fin-current-fy-target').html('-');
                    $('.april-ink-fin-current-fy-actual').html('-');
                }
            } else {
            ...
            if(jQuery.inArray(5, datas) != -1) {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-fin-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-fin-actual-target').html(mayDifference);
                        $('.may-ink-fin-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-fin-tricolor').html('-');
                        $('.may-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.may-ink-fin-actual-target').html('-');
                $('.may-ink-fin-tricolor').html('-');
                $('.may-ink-fin-current-fy-target').html('-');
                $('.may-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-fin-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-fin-actual-target').html(juneDifference);
                        $('.june-ink-fin-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-fin-tricolor').html('-');
                        $('.june-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-fin-actual-target').html('-');
                $('.june-ink-fin-tricolor').html('-');
                $('.june-ink-fin-current-fy-target').html('-');
                $('.june-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-fin-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-fin-actual-target').html(julyDifference);
                        $('.july-ink-fin-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-fin-tricolor').html('-');
                        $('.july-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-fin-actual-target').html('-');
                $('.july-ink-fin-tricolor').html('-');
                $('.july-ink-fin-current-fy-target').html('-');
                $('.july-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-fin-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-fin-actual-target').html(augustDifference);
                        $('.august-ink-fin-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-fin-tricolor').html('-');
                        $('.august-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-fin-actual-target').html('-');
                $('.august-ink-fin-tricolor').html('-');
                $('.august-ink-fin-current-fy-target').html('-');
                $('.august-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-fin-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-fin-actual-target').html(septemberDifference);
                        $('.september-ink-fin-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-fin-tricolor').html('-');
                        $('.september-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-fin-actual-target').html('-');
                $('.september-ink-fin-tricolor').html('-');
                $('.september-ink-fin-current-fy-target').html('-');
                $('.september-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-fin-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-fin-actual-target').html(octoberDifference);
                        $('.october-ink-fin-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-fin-tricolor').html('-');
                        $('.october-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-fin-actual-target').html('-');
                $('.october-ink-fin-tricolor').html('-');
                $('.october-ink-fin-current-fy-target').html('-');
                $('.october-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-fin-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-fin-actual-target').html(novemberDifference);
                        $('.november-ink-fin-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-fin-tricolor').html('-');
                        $('.november-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-fin-actual-target').html('-');
                $('.november-ink-fin-tricolor').html('-');
                $('.november-ink-fin-current-fy-target').html('-');
                $('.november-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-fin-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-fin-actual-target').html(decemberDifference);
                        $('.december-ink-fin-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-fin-tricolor').html('-');
                        $('.december-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-fin-actual-target').html('-');
                $('.december-ink-fin-tricolor').html('-');
                $('.december-ink-fin-current-fy-target').html('-');
                $('.december-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-fin-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-fin-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-fin-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-fin-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-fin-tricolor').html('-');
                        $('.january-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-fin-actual-target').html('-');
                $('.january-ink-fin-tricolor').html('-');
                $('.january-ink-fin-current-fy-target').html('-');
                $('.january-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-fin-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-fin-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-fin-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-fin-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-fin-tricolor').html('-');
                        $('.february-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-fin-actual-target').html('-');
                $('.february-ink-fin-tricolor').html('-');
                $('.february-ink-fin-current-fy-target').html('-');
                $('.february-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-fin-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-fin-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-fin-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-fin-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-fin-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-fin-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-fin-tricolor').html('-');
                        $('.march-ink-fin-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-fin-actual-target').html('-');
                $('.march-ink-fin-tricolor').html('-');
                $('.march-ink-fin-current-fy-target').html('-');
                $('.march-ink-fin-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-fin-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-fin-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-fin-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-fin-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-fin-actual-target').html(difference);
            $('.total-ink-fin-tricolor').html(difference);
        } else {
            $('.total-ink-fin-actual-target').html('-');
            $('.total-ink-fin-tricolor').html('-');
            
        }

            $('.april-ink-fin-current-fy').html('April ' + currentYear);
            $('.may-ink-fin-current-fy').html('May ' + currentYear);
            $('.june-ink-fin-current-fy').html('June ' + currentYear);
            $('.july-ink-fin-current-fy').html('July ' + currentYear);
            $('.august-ink-fin-current-fy').html('August ' + currentYear);
            $('.september-ink-fin-current-fy').html('September ' + currentYear);
            $('.october-ink-fin-current-fy').html('October ' + currentYear);
            $('.november-ink-fin-current-fy').html('November ' + currentYear);
            $('.december-ink-fin-current-fy').html('December ' + currentYear);
            $('.january-ink-fin-current-fy').html('January ' + nextYear);
            $('.february-ink-fin-current-fy').html('February ' + nextYear);
            $('.march-ink-fin-current-fy').html('March ' + nextYear); 
        }
    });
}