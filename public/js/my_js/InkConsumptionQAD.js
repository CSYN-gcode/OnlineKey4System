function GetCurrentFYInkDataQAD() {
    $.ajax({
        url: 'get_current_ink_data_qad',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkQAD').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-qad-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-qad-actual-target').html(aprilDifference);
                        
                        $('.april-ink-qad-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-qad-tricolor').html('-');
                        $('.april-ink-qad-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-qad-actual-target').html('-');
                    $('.april-ink-qad-current-fy-target').html('-');
                    $('.april-ink-qad-current-fy-actual').html('-');
                }
            } else {
            ...
            if(jQuery.inArray(5, datas) != -1) {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-qad-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-qad-actual-target').html(mayDifference);
                        $('.may-ink-qad-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-qad-tricolor').html('-');
                        $('.may-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.may-ink-qad-actual-target').html('-');
                $('.may-ink-qad-tricolor').html('-');
                $('.may-ink-qad-current-fy-target').html('-');
                $('.may-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-qad-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-qad-actual-target').html(juneDifference);
                        $('.june-ink-qad-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-qad-tricolor').html('-');
                        $('.june-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-qad-actual-target').html('-');
                $('.june-ink-qad-tricolor').html('-');
                $('.june-ink-qad-current-fy-target').html('-');
                $('.june-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-qad-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-qad-actual-target').html(julyDifference);
                        $('.july-ink-qad-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-qad-tricolor').html('-');
                        $('.july-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-qad-actual-target').html('-');
                $('.july-ink-qad-tricolor').html('-');
                $('.july-ink-qad-current-fy-target').html('-');
                $('.july-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-qad-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-qad-actual-target').html(augustDifference);
                        $('.august-ink-qad-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-qad-tricolor').html('-');
                        $('.august-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-qad-actual-target').html('-');
                $('.august-ink-qad-tricolor').html('-');
                $('.august-ink-qad-current-fy-target').html('-');
                $('.august-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-qad-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-qad-actual-target').html(septemberDifference);
                        $('.september-ink-qad-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-qad-tricolor').html('-');
                        $('.september-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-qad-actual-target').html('-');
                $('.september-ink-qad-tricolor').html('-');
                $('.september-ink-qad-current-fy-target').html('-');
                $('.september-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-qad-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-qad-actual-target').html(octoberDifference);
                        $('.october-ink-qad-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-qad-tricolor').html('-');
                        $('.october-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-qad-actual-target').html('-');
                $('.october-ink-qad-tricolor').html('-');
                $('.october-ink-qad-current-fy-target').html('-');
                $('.october-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-qad-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-qad-actual-target').html(novemberDifference);
                        $('.november-ink-qad-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-qad-tricolor').html('-');
                        $('.november-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-qad-actual-target').html('-');
                $('.november-ink-qad-tricolor').html('-');
                $('.november-ink-qad-current-fy-target').html('-');
                $('.november-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-qad-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-qad-actual-target').html(decemberDifference);
                        $('.december-ink-qad-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-qad-tricolor').html('-');
                        $('.december-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-qad-actual-target').html('-');
                $('.december-ink-qad-tricolor').html('-');
                $('.december-ink-qad-current-fy-target').html('-');
                $('.december-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-qad-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-qad-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-qad-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-qad-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-qad-tricolor').html('-');
                        $('.january-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-qad-actual-target').html('-');
                $('.january-ink-qad-tricolor').html('-');
                $('.january-ink-qad-current-fy-target').html('-');
                $('.january-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-qad-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-qad-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-qad-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-qad-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-qad-tricolor').html('-');
                        $('.february-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-qad-actual-target').html('-');
                $('.february-ink-qad-tricolor').html('-');
                $('.february-ink-qad-current-fy-target').html('-');
                $('.february-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-qad-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-qad-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-qad-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-qad-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-qad-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-qad-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-qad-tricolor').html('-');
                        $('.march-ink-qad-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-qad-actual-target').html('-');
                $('.march-ink-qad-tricolor').html('-');
                $('.march-ink-qad-current-fy-target').html('-');
                $('.march-ink-qad-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-qad-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-qad-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-qad-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-qad-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-qad-actual-target').html(difference);
            $('.total-ink-qad-tricolor').html(difference);
        } else {
            $('.total-ink-qad-actual-target').html('-');
            $('.total-ink-qad-tricolor').html('-');
            
        }

            $('.april-ink-qad-current-fy').html('April ' + currentYear);
            $('.may-ink-qad-current-fy').html('May ' + currentYear);
            $('.june-ink-qad-current-fy').html('June ' + currentYear);
            $('.july-ink-qad-current-fy').html('July ' + currentYear);
            $('.august-ink-qad-current-fy').html('August ' + currentYear);
            $('.september-ink-qad-current-fy').html('September ' + currentYear);
            $('.october-ink-qad-current-fy').html('October ' + currentYear);
            $('.november-ink-qad-current-fy').html('November ' + currentYear);
            $('.december-ink-qad-current-fy').html('December ' + currentYear);
            $('.january-ink-qad-current-fy').html('January ' + nextYear);
            $('.february-ink-qad-current-fy').html('February ' + nextYear);
            $('.march-ink-qad-current-fy').html('March ' + nextYear); 
        }
    });
}