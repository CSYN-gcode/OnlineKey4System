function GetCurrentFYInkDataHRD() {
    $.ajax({
        url: 'get_current_ink_data_hrd',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkHRD').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-hrd-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-hrd-actual-target').html(aprilDifference);
                        
                        $('.april-ink-hrd-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-hrd-tricolor').html('-');
                        $('.april-ink-hrd-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-hrd-actual-target').html('-');
                    $('.april-ink-hrd-current-fy-target').html('-');
                    $('.april-ink-hrd-current-fy-actual').html('-');
                }
            } else {
            ...
            if(jQuery.inArray(5, datas) != -1) {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-hrd-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-hrd-actual-target').html(mayDifference);
                        $('.may-ink-hrd-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-hrd-tricolor').html('-');
                        $('.may-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.may-ink-hrd-actual-target').html('-');
                $('.may-ink-hrd-tricolor').html('-');
                $('.may-ink-hrd-current-fy-target').html('-');
                $('.may-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-hrd-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-hrd-actual-target').html(juneDifference);
                        $('.june-ink-hrd-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-hrd-tricolor').html('-');
                        $('.june-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-hrd-actual-target').html('-');
                $('.june-ink-hrd-tricolor').html('-');
                $('.june-ink-hrd-current-fy-target').html('-');
                $('.june-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-hrd-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-hrd-actual-target').html(julyDifference);
                        $('.july-ink-hrd-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-hrd-tricolor').html('-');
                        $('.july-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-hrd-actual-target').html('-');
                $('.july-ink-hrd-tricolor').html('-');
                $('.july-ink-hrd-current-fy-target').html('-');
                $('.july-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-hrd-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-hrd-actual-target').html(augustDifference);
                        $('.august-ink-hrd-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-hrd-tricolor').html('-');
                        $('.august-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-hrd-actual-target').html('-');
                $('.august-ink-hrd-tricolor').html('-');
                $('.august-ink-hrd-current-fy-target').html('-');
                $('.august-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-hrd-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-hrd-actual-target').html(septemberDifference);
                        $('.september-ink-hrd-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-hrd-tricolor').html('-');
                        $('.september-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-hrd-actual-target').html('-');
                $('.september-ink-hrd-tricolor').html('-');
                $('.september-ink-hrd-current-fy-target').html('-');
                $('.september-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-hrd-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-hrd-actual-target').html(octoberDifference);
                        $('.october-ink-hrd-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-hrd-tricolor').html('-');
                        $('.october-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-hrd-actual-target').html('-');
                $('.october-ink-hrd-tricolor').html('-');
                $('.october-ink-hrd-current-fy-target').html('-');
                $('.october-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-hrd-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-hrd-actual-target').html(novemberDifference);
                        $('.november-ink-hrd-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-hrd-tricolor').html('-');
                        $('.november-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-hrd-actual-target').html('-');
                $('.november-ink-hrd-tricolor').html('-');
                $('.november-ink-hrd-current-fy-target').html('-');
                $('.november-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-hrd-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-hrd-actual-target').html(decemberDifference);
                        $('.december-ink-hrd-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-hrd-tricolor').html('-');
                        $('.december-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-hrd-actual-target').html('-');
                $('.december-ink-hrd-tricolor').html('-');
                $('.december-ink-hrd-current-fy-target').html('-');
                $('.december-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-hrd-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-hrd-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-hrd-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-hrd-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-hrd-tricolor').html('-');
                        $('.january-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-hrd-actual-target').html('-');
                $('.january-ink-hrd-tricolor').html('-');
                $('.january-ink-hrd-current-fy-target').html('-');
                $('.january-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-hrd-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-hrd-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-hrd-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-hrd-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-hrd-tricolor').html('-');
                        $('.february-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-hrd-actual-target').html('-');
                $('.february-ink-hrd-tricolor').html('-');
                $('.february-ink-hrd-current-fy-target').html('-');
                $('.february-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-hrd-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-hrd-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-hrd-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-hrd-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-hrd-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-hrd-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-hrd-tricolor').html('-');
                        $('.march-ink-hrd-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-hrd-actual-target').html('-');
                $('.march-ink-hrd-tricolor').html('-');
                $('.march-ink-hrd-current-fy-target').html('-');
                $('.march-ink-hrd-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-hrd-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-hrd-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-hrd-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-hrd-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-hrd-actual-target').html(difference);
            $('.total-ink-hrd-tricolor').html(difference);
        } else {
            $('.total-ink-hrd-actual-target').html('-');
            $('.total-ink-hrd-tricolor').html('-');
            
        }

            $('.april-ink-hrd-current-fy').html('April ' + currentYear);
            $('.may-ink-hrd-current-fy').html('May ' + currentYear);
            $('.june-ink-hrd-current-fy').html('June ' + currentYear);
            $('.july-ink-hrd-current-fy').html('July ' + currentYear);
            $('.august-ink-hrd-current-fy').html('August ' + currentYear);
            $('.september-ink-hrd-current-fy').html('September ' + currentYear);
            $('.october-ink-hrd-current-fy').html('October ' + currentYear);
            $('.november-ink-hrd-current-fy').html('November ' + currentYear);
            $('.december-ink-hrd-current-fy').html('December ' + currentYear);
            $('.january-ink-hrd-current-fy').html('January ' + nextYear);
            $('.february-ink-hrd-current-fy').html('February ' + nextYear);
            $('.march-ink-hrd-current-fy').html('March ' + nextYear); 
        }
    });
}