function GetCurrentFYInkDataTS() {
    $.ajax({
        url: 'get_current_ink_data_ts',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkTS').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-ts-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-ts-actual-target').html(aprilDifference);
                        
                        $('.april-ink-ts-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-ts-tricolor').html('-');
                        $('.april-ink-ts-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-ts-actual-target').html('-');
                    $('.april-ink-ts-current-fy-target').html('-');
                    $('.april-ink-ts-current-fy-actual').html('-');
                }
            } else {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-ts-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-ts-actual-target').html(mayDifference);
                        $('.may-ink-ts-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-ts-tricolor').html('-');
                        $('.may-ink-ts-current-fy-actual').html('-');
                     }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-ts-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-ts-actual-target').html(juneDifference);
                        $('.june-ink-ts-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-ts-tricolor').html('-');
                        $('.june-ink-ts-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-ts-actual-target').html('-');
                $('.june-ink-ts-tricolor').html('-');
                $('.june-ink-ts-current-fy-target').html('-');
                $('.june-ink-ts-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-ts-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-ts-actual-target').html(julyDifference);
                        $('.july-ink-ts-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-ts-tricolor').html('-');
                        $('.july-ink-ts-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-ts-actual-target').html('-');
                $('.july-ink-ts-tricolor').html('-');
                $('.july-ink-ts-current-fy-target').html('-');
                $('.july-ink-ts-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-ts-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-ts-actual-target').html(augustDifference);
                        $('.august-ink-ts-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-ts-tricolor').html('-');
                        $('.august-ink-ts-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-ts-actual-target').html('-');
                $('.august-ink-ts-tricolor').html('-');
                $('.august-ink-ts-current-fy-target').html('-');
                $('.august-ink-ts-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-ts-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-ts-actual-target').html(septemberDifference);
                        $('.september-ink-ts-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-ts-tricolor').html('-');
                        $('.september-ink-ts-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-ts-actual-target').html('-');
                $('.september-ink-ts-tricolor').html('-');
                $('.september-ink-ts-current-fy-target').html('-');
                $('.september-ink-ts-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-ts-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-ts-actual-target').html(octoberDifference);
                        $('.october-ink-ts-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-ts-tricolor').html('-');
                        $('.october-ink-ts-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-ts-actual-target').html('-');
                $('.october-ink-ts-tricolor').html('-');
                $('.october-ink-ts-current-fy-target').html('-');
                $('.october-ink-ts-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-ts-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-ts-actual-target').html(novemberDifference);
                        $('.november-ink-ts-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-ts-tricolor').html('-');
                        $('.november-ink-ts-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-ts-actual-target').html('-');
                $('.november-ink-ts-tricolor').html('-');
                $('.november-ink-ts-current-fy-target').html('-');
                $('.november-ink-ts-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-ts-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-ts-actual-target').html(decemberDifference);
                        $('.december-ink-ts-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-ts-tricolor').html('-');
                        $('.december-ink-ts-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-ts-actual-target').html('-');
                $('.december-ink-ts-tricolor').html('-');
                $('.december-ink-ts-current-fy-target').html('-');
                $('.december-ink-ts-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-ts-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-ts-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-ts-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-ts-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-ts-tricolor').html('-');
                        $('.january-ink-ts-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-ts-actual-target').html('-');
                $('.january-ink-ts-tricolor').html('-');
                $('.january-ink-ts-current-fy-target').html('-');
                $('.january-ink-ts-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-ts-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-ts-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-ts-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-ts-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-ts-tricolor').html('-');
                        $('.february-ink-ts-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-ts-actual-target').html('-');
                $('.february-ink-ts-tricolor').html('-');
                $('.february-ink-ts-current-fy-target').html('-');
                $('.february-ink-ts-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-ts-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-ts-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-ts-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-ts-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-ts-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-ts-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-ts-tricolor').html('-');
                        $('.march-ink-ts-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-ts-actual-target').html('-');
                $('.march-ink-ts-tricolor').html('-');
                $('.march-ink-ts-current-fy-target').html('-');
                $('.march-ink-ts-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-ts-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-ts-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-ts-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-ts-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-ts-actual-target').html(difference);
            $('.total-ink-ts-tricolor').html(difference);
        } else {
            $('.total-ink-ts-actual-target').html('-');
            $('.total-ink-ts-tricolor').html('-');
            
        }

            $('.april-ink-ts-current-fy').html('April ' + currentYear);
            $('.may-ink-ts-current-fy').html('May ' + currentYear);
            $('.june-ink-ts-current-fy').html('June ' + currentYear);
            $('.july-ink-ts-current-fy').html('July ' + currentYear);
            $('.august-ink-ts-current-fy').html('August ' + currentYear);
            $('.september-ink-ts-current-fy').html('September ' + currentYear);
            $('.october-ink-ts-current-fy').html('October ' + currentYear);
            $('.november-ink-ts-current-fy').html('November ' + currentYear);
            $('.december-ink-ts-current-fy').html('December ' + currentYear);
            $('.january-ink-ts-current-fy').html('January ' + nextYear);
            $('.february-ink-ts-current-fy').html('February ' + nextYear);
            $('.march-ink-ts-current-fy').html('March ' + nextYear); 
        }
    });
}