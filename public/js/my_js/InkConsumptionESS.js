function GetCurrentFYInkDataESS() {
    $.ajax({
        url: 'get_current_ink_data_ess',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkESS').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-ess-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-ess-actual-target').html(aprilDifference);
                        
                        $('.april-ink-ess-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-ess-tricolor').html('-');
                        $('.april-ink-ess-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-ess-actual-target').html('-');
                    $('.april-ink-ess-current-fy-target').html('-');
                    $('.april-ink-ess-current-fy-actual').html('-');
                }
            } else {
            ...
            if(jQuery.inArray(5, datas) != -1) {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-ess-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-ess-actual-target').html(mayDifference);
                        $('.may-ink-ess-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-ess-tricolor').html('-');
                        $('.may-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.may-ink-ess-actual-target').html('-');
                $('.may-ink-ess-tricolor').html('-');
                $('.may-ink-ess-current-fy-target').html('-');
                $('.may-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-ess-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-ess-actual-target').html(juneDifference);
                        $('.june-ink-ess-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-ess-tricolor').html('-');
                        $('.june-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-ess-actual-target').html('-');
                $('.june-ink-ess-tricolor').html('-');
                $('.june-ink-ess-current-fy-target').html('-');
                $('.june-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-ess-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-ess-actual-target').html(julyDifference);
                        $('.july-ink-ess-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-ess-tricolor').html('-');
                        $('.july-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-ess-actual-target').html('-');
                $('.july-ink-ess-tricolor').html('-');
                $('.july-ink-ess-current-fy-target').html('-');
                $('.july-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-ess-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-ess-actual-target').html(augustDifference);
                        $('.august-ink-ess-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-ess-tricolor').html('-');
                        $('.august-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-ess-actual-target').html('-');
                $('.august-ink-ess-tricolor').html('-');
                $('.august-ink-ess-current-fy-target').html('-');
                $('.august-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-ess-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-ess-actual-target').html(septemberDifference);
                        $('.september-ink-ess-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-ess-tricolor').html('-');
                        $('.september-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-ess-actual-target').html('-');
                $('.september-ink-ess-tricolor').html('-');
                $('.september-ink-ess-current-fy-target').html('-');
                $('.september-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-ess-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-ess-actual-target').html(octoberDifference);
                        $('.october-ink-ess-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-ess-tricolor').html('-');
                        $('.october-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-ess-actual-target').html('-');
                $('.october-ink-ess-tricolor').html('-');
                $('.october-ink-ess-current-fy-target').html('-');
                $('.october-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-ess-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-ess-actual-target').html(novemberDifference);
                        $('.november-ink-ess-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-ess-tricolor').html('-');
                        $('.november-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-ess-actual-target').html('-');
                $('.november-ink-ess-tricolor').html('-');
                $('.november-ink-ess-current-fy-target').html('-');
                $('.november-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-ess-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-ess-actual-target').html(decemberDifference);
                        $('.december-ink-ess-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-ess-tricolor').html('-');
                        $('.december-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-ess-actual-target').html('-');
                $('.december-ink-ess-tricolor').html('-');
                $('.december-ink-ess-current-fy-target').html('-');
                $('.december-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-ess-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-ess-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-ess-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-ess-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-ess-tricolor').html('-');
                        $('.january-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-ess-actual-target').html('-');
                $('.january-ink-ess-tricolor').html('-');
                $('.january-ink-ess-current-fy-target').html('-');
                $('.january-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-ess-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-ess-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-ess-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-ess-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-ess-tricolor').html('-');
                        $('.february-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-ess-actual-target').html('-');
                $('.february-ink-ess-tricolor').html('-');
                $('.february-ink-ess-current-fy-target').html('-');
                $('.february-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-ess-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-ess-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-ess-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-ess-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-ess-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-ess-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-ess-tricolor').html('-');
                        $('.march-ink-ess-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-ess-actual-target').html('-');
                $('.march-ink-ess-tricolor').html('-');
                $('.march-ink-ess-current-fy-target').html('-');
                $('.march-ink-ess-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-ess-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-ess-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-ess-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-ess-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-ess-actual-target').html(difference);
            $('.total-ink-ess-tricolor').html(difference);
        } else {
            $('.total-ink-ess-actual-target').html('-');
            $('.total-ink-ess-tricolor').html('-');
            
        }

            $('.april-ink-ess-current-fy').html('April ' + currentYear);
            $('.may-ink-ess-current-fy').html('May ' + currentYear);
            $('.june-ink-ess-current-fy').html('June ' + currentYear);
            $('.july-ink-ess-current-fy').html('July ' + currentYear);
            $('.august-ink-ess-current-fy').html('August ' + currentYear);
            $('.september-ink-ess-current-fy').html('September ' + currentYear);
            $('.october-ink-ess-current-fy').html('October ' + currentYear);
            $('.november-ink-ess-current-fy').html('November ' + currentYear);
            $('.december-ink-ess-current-fy').html('December ' + currentYear);
            $('.january-ink-ess-current-fy').html('January ' + nextYear);
            $('.february-ink-ess-current-fy').html('February ' + nextYear);
            $('.march-ink-ess-current-fy').html('March ' + nextYear); 
        }
    });
}