function GetCurrentFYInkDataBOD() {
    $.ajax({
        url: 'get_current_ink_data_bod',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkBOD').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-bod-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-bod-actual-target').html(aprilDifference);
                        
                        $('.april-ink-bod-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-bod-tricolor').html('-');
                        $('.april-ink-bod-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-bod-actual-target').html('-');
                    $('.april-ink-bod-current-fy-target').html('-');
                    $('.april-ink-bod-current-fy-actual').html('-');
                }
            } else {
            ...
            if(jQuery.inArray(5, datas) != -1) {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-bod-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-bod-actual-target').html(mayDifference);
                        $('.may-ink-bod-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-bod-tricolor').html('-');
                        $('.may-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.may-ink-bod-actual-target').html('-');
                $('.may-ink-bod-tricolor').html('-');
                $('.may-ink-bod-current-fy-target').html('-');
                $('.may-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-bod-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-bod-actual-target').html(juneDifference);
                        $('.june-ink-bod-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-bod-tricolor').html('-');
                        $('.june-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-bod-actual-target').html('-');
                $('.june-ink-bod-tricolor').html('-');
                $('.june-ink-bod-current-fy-target').html('-');
                $('.june-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-bod-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-bod-actual-target').html(julyDifference);
                        $('.july-ink-bod-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-bod-tricolor').html('-');
                        $('.july-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-bod-actual-target').html('-');
                $('.july-ink-bod-tricolor').html('-');
                $('.july-ink-bod-current-fy-target').html('-');
                $('.july-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-bod-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-bod-actual-target').html(augustDifference);
                        $('.august-ink-bod-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-bod-tricolor').html('-');
                        $('.august-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-bod-actual-target').html('-');
                $('.august-ink-bod-tricolor').html('-');
                $('.august-ink-bod-current-fy-target').html('-');
                $('.august-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-bod-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-bod-actual-target').html(septemberDifference);
                        $('.september-ink-bod-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-bod-tricolor').html('-');
                        $('.september-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-bod-actual-target').html('-');
                $('.september-ink-bod-tricolor').html('-');
                $('.september-ink-bod-current-fy-target').html('-');
                $('.september-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-bod-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-bod-actual-target').html(octoberDifference);
                        $('.october-ink-bod-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-bod-tricolor').html('-');
                        $('.october-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-bod-actual-target').html('-');
                $('.october-ink-bod-tricolor').html('-');
                $('.october-ink-bod-current-fy-target').html('-');
                $('.october-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-bod-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-bod-actual-target').html(novemberDifference);
                        $('.november-ink-bod-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-bod-tricolor').html('-');
                        $('.november-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-bod-actual-target').html('-');
                $('.november-ink-bod-tricolor').html('-');
                $('.november-ink-bod-current-fy-target').html('-');
                $('.november-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-bod-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-bod-actual-target').html(decemberDifference);
                        $('.december-ink-bod-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-bod-tricolor').html('-');
                        $('.december-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-bod-actual-target').html('-');
                $('.december-ink-bod-tricolor').html('-');
                $('.december-ink-bod-current-fy-target').html('-');
                $('.december-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-bod-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-bod-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-bod-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-bod-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-bod-tricolor').html('-');
                        $('.january-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-bod-actual-target').html('-');
                $('.january-ink-bod-tricolor').html('-');
                $('.january-ink-bod-current-fy-target').html('-');
                $('.january-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-bod-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-bod-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-bod-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-bod-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-bod-tricolor').html('-');
                        $('.february-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-bod-actual-target').html('-');
                $('.february-ink-bod-tricolor').html('-');
                $('.february-ink-bod-current-fy-target').html('-');
                $('.february-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-bod-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-bod-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-bod-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-bod-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-bod-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-bod-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-bod-tricolor').html('-');
                        $('.march-ink-bod-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-bod-actual-target').html('-');
                $('.march-ink-bod-tricolor').html('-');
                $('.march-ink-bod-current-fy-target').html('-');
                $('.march-ink-bod-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-bod-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-bod-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-bod-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-bod-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-bod-actual-target').html(difference);
            $('.total-ink-bod-tricolor').html(difference);
        } else {
            $('.total-ink-bod-actual-target').html('-');
            $('.total-ink-bod-tricolor').html('-');
            
        }

            $('.april-ink-bod-current-fy').html('April ' + currentYear);
            $('.may-ink-bod-current-fy').html('May ' + currentYear);
            $('.june-ink-bod-current-fy').html('June ' + currentYear);
            $('.july-ink-bod-current-fy').html('July ' + currentYear);
            $('.august-ink-bod-current-fy').html('August ' + currentYear);
            $('.september-ink-bod-current-fy').html('September ' + currentYear);
            $('.october-ink-bod-current-fy').html('October ' + currentYear);
            $('.november-ink-bod-current-fy').html('November ' + currentYear);
            $('.december-ink-bod-current-fy').html('December ' + currentYear);
            $('.january-ink-bod-current-fy').html('January ' + nextYear);
            $('.february-ink-bod-current-fy').html('February ' + nextYear);
            $('.march-ink-bod-current-fy').html('March ' + nextYear); 
        }
    });
}