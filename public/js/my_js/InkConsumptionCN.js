function GetCurrentFYInkDataCN() {
    $.ajax({
        url: 'get_current_ink_data_cn',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkCN').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-cn-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-cn-actual-target').html(aprilDifference);
                        
                        $('.april-ink-cn-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-cn-tricolor').html('-');
                        $('.april-ink-cn-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-cn-actual-target').html('-');
                    $('.april-ink-cn-current-fy-target').html('-');
                    $('.april-ink-cn-current-fy-actual').html('-');
                }
            } else {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-cn-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-cn-actual-target').html(mayDifference);
                        $('.may-ink-cn-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-cn-tricolor').html('-');
                        $('.may-ink-cn-current-fy-actual').html('-');
                     }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-cn-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-cn-actual-target').html(juneDifference);
                        $('.june-ink-cn-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-cn-tricolor').html('-');
                        $('.june-ink-cn-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-cn-actual-target').html('-');
                $('.june-ink-cn-tricolor').html('-');
                $('.june-ink-cn-current-fy-target').html('-');
                $('.june-ink-cn-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-cn-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-cn-actual-target').html(julyDifference);
                        $('.july-ink-cn-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-cn-tricolor').html('-');
                        $('.july-ink-cn-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-cn-actual-target').html('-');
                $('.july-ink-cn-tricolor').html('-');
                $('.july-ink-cn-current-fy-target').html('-');
                $('.july-ink-cn-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-cn-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-cn-actual-target').html(augustDifference);
                        $('.august-ink-cn-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-cn-tricolor').html('-');
                        $('.august-ink-cn-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-cn-actual-target').html('-');
                $('.august-ink-cn-tricolor').html('-');
                $('.august-ink-cn-current-fy-target').html('-');
                $('.august-ink-cn-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-cn-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-cn-actual-target').html(septemberDifference);
                        $('.september-ink-cn-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-cn-tricolor').html('-');
                        $('.september-ink-cn-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-cn-actual-target').html('-');
                $('.september-ink-cn-tricolor').html('-');
                $('.september-ink-cn-current-fy-target').html('-');
                $('.september-ink-cn-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-cn-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-cn-actual-target').html(octoberDifference);
                        $('.october-ink-cn-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-cn-tricolor').html('-');
                        $('.october-ink-cn-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-cn-actual-target').html('-');
                $('.october-ink-cn-tricolor').html('-');
                $('.october-ink-cn-current-fy-target').html('-');
                $('.october-ink-cn-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-cn-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-cn-actual-target').html(novemberDifference);
                        $('.november-ink-cn-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-cn-tricolor').html('-');
                        $('.november-ink-cn-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-cn-actual-target').html('-');
                $('.november-ink-cn-tricolor').html('-');
                $('.november-ink-cn-current-fy-target').html('-');
                $('.november-ink-cn-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-cn-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-cn-actual-target').html(decemberDifference);
                        $('.december-ink-cn-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-cn-tricolor').html('-');
                        $('.december-ink-cn-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-cn-actual-target').html('-');
                $('.december-ink-cn-tricolor').html('-');
                $('.december-ink-cn-current-fy-target').html('-');
                $('.december-ink-cn-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-cn-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-cn-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-cn-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-cn-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-cn-tricolor').html('-');
                        $('.january-ink-cn-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-cn-actual-target').html('-');
                $('.january-ink-cn-tricolor').html('-');
                $('.january-ink-cn-current-fy-target').html('-');
                $('.january-ink-cn-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-cn-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-cn-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-cn-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-cn-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-cn-tricolor').html('-');
                        $('.february-ink-cn-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-cn-actual-target').html('-');
                $('.february-ink-cn-tricolor').html('-');
                $('.february-ink-cn-current-fy-target').html('-');
                $('.february-ink-cn-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-cn-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-cn-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-cn-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-cn-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-cn-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-cn-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-cn-tricolor').html('-');
                        $('.march-ink-cn-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-cn-actual-target').html('-');
                $('.march-ink-cn-tricolor').html('-');
                $('.march-ink-cn-current-fy-target').html('-');
                $('.march-ink-cn-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-cn-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-cn-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-cn-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-cn-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-cn-actual-target').html(difference);
            $('.total-ink-cn-tricolor').html(difference);
        } else {
            $('.total-ink-cn-actual-target').html('-');
            $('.total-ink-cn-tricolor').html('-');
            
        }

            $('.april-ink-cn-current-fy').html('April ' + currentYear);
            $('.may-ink-cn-current-fy').html('May ' + currentYear);
            $('.june-ink-cn-current-fy').html('June ' + currentYear);
            $('.july-ink-cn-current-fy').html('July ' + currentYear);
            $('.august-ink-cn-current-fy').html('August ' + currentYear);
            $('.september-ink-cn-current-fy').html('September ' + currentYear);
            $('.october-ink-cn-current-fy').html('October ' + currentYear);
            $('.november-ink-cn-current-fy').html('November ' + currentYear);
            $('.december-ink-cn-current-fy').html('December ' + currentYear);
            $('.january-ink-cn-current-fy').html('January ' + nextYear);
            $('.february-ink-cn-current-fy').html('February ' + nextYear);
            $('.march-ink-cn-current-fy').html('March ' + nextYear); 
        }
    });
}