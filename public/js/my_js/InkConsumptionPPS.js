function GetCurrentFYInkDataPPS() {
    $.ajax({
        url: 'get_current_ink_data_pps',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkPPS').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-pps-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-pps-actual-target').html(aprilDifference);
                        
                        $('.april-ink-pps-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-pps-tricolor').html('-');
                        $('.april-ink-pps-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-pps-actual-target').html('-');
                    $('.april-ink-pps-current-fy-target').html('-');
                    $('.april-ink-pps-current-fy-actual').html('-');
                }
            } else {
            ...
            if(jQuery.inArray(5, datas) != -1) {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-pps-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-pps-actual-target').html(mayDifference);
                        $('.may-ink-pps-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-pps-tricolor').html('-');
                        $('.may-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.may-ink-pps-actual-target').html('-');
                $('.may-ink-pps-tricolor').html('-');
                $('.may-ink-pps-current-fy-target').html('-');
                $('.may-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-pps-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-pps-actual-target').html(juneDifference);
                        $('.june-ink-pps-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-pps-tricolor').html('-');
                        $('.june-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-pps-actual-target').html('-');
                $('.june-ink-pps-tricolor').html('-');
                $('.june-ink-pps-current-fy-target').html('-');
                $('.june-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-pps-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-pps-actual-target').html(julyDifference);
                        $('.july-ink-pps-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-pps-tricolor').html('-');
                        $('.july-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-pps-actual-target').html('-');
                $('.july-ink-pps-tricolor').html('-');
                $('.july-ink-pps-current-fy-target').html('-');
                $('.july-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-pps-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-pps-actual-target').html(augustDifference);
                        $('.august-ink-pps-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-pps-tricolor').html('-');
                        $('.august-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-pps-actual-target').html('-');
                $('.august-ink-pps-tricolor').html('-');
                $('.august-ink-pps-current-fy-target').html('-');
                $('.august-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-pps-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-pps-actual-target').html(septemberDifference);
                        $('.september-ink-pps-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-pps-tricolor').html('-');
                        $('.september-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-pps-actual-target').html('-');
                $('.september-ink-pps-tricolor').html('-');
                $('.september-ink-pps-current-fy-target').html('-');
                $('.september-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-pps-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-pps-actual-target').html(octoberDifference);
                        $('.october-ink-pps-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-pps-tricolor').html('-');
                        $('.october-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-pps-actual-target').html('-');
                $('.october-ink-pps-tricolor').html('-');
                $('.october-ink-pps-current-fy-target').html('-');
                $('.october-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-pps-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-pps-actual-target').html(novemberDifference);
                        $('.november-ink-pps-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-pps-tricolor').html('-');
                        $('.november-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-pps-actual-target').html('-');
                $('.november-ink-pps-tricolor').html('-');
                $('.november-ink-pps-current-fy-target').html('-');
                $('.november-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-pps-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-pps-actual-target').html(decemberDifference);
                        $('.december-ink-pps-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-pps-tricolor').html('-');
                        $('.december-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-pps-actual-target').html('-');
                $('.december-ink-pps-tricolor').html('-');
                $('.december-ink-pps-current-fy-target').html('-');
                $('.december-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-pps-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-pps-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-pps-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-pps-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-pps-tricolor').html('-');
                        $('.january-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-pps-actual-target').html('-');
                $('.january-ink-pps-tricolor').html('-');
                $('.january-ink-pps-current-fy-target').html('-');
                $('.january-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-pps-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-pps-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-pps-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-pps-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-pps-tricolor').html('-');
                        $('.february-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-pps-actual-target').html('-');
                $('.february-ink-pps-tricolor').html('-');
                $('.february-ink-pps-current-fy-target').html('-');
                $('.february-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-pps-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-pps-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-pps-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-pps-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-pps-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-pps-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-pps-tricolor').html('-');
                        $('.march-ink-pps-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-pps-actual-target').html('-');
                $('.march-ink-pps-tricolor').html('-');
                $('.march-ink-pps-current-fy-target').html('-');
                $('.march-ink-pps-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-pps-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-pps-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-pps-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-pps-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-pps-actual-target').html(difference);
            $('.total-ink-pps-tricolor').html(difference);
        } else {
            $('.total-ink-pps-actual-target').html('-');
            $('.total-ink-pps-tricolor').html('-');
            
        }

            $('.april-ink-pps-current-fy').html('April ' + currentYear);
            $('.may-ink-pps-current-fy').html('May ' + currentYear);
            $('.june-ink-pps-current-fy').html('June ' + currentYear);
            $('.july-ink-pps-current-fy').html('July ' + currentYear);
            $('.august-ink-pps-current-fy').html('August ' + currentYear);
            $('.september-ink-pps-current-fy').html('September ' + currentYear);
            $('.october-ink-pps-current-fy').html('October ' + currentYear);
            $('.november-ink-pps-current-fy').html('November ' + currentYear);
            $('.december-ink-pps-current-fy').html('December ' + currentYear);
            $('.january-ink-pps-current-fy').html('January ' + nextYear);
            $('.february-ink-pps-current-fy').html('February ' + nextYear);
            $('.march-ink-pps-current-fy').html('March ' + nextYear); 
        }
    });
}