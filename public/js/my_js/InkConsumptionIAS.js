function GetCurrentFYInkDataIAS() {
    $.ajax({
        url: 'get_current_ink_data_ias',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkIAS').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-ias-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-ias-actual-target').html(aprilDifference);
                        
                        $('.april-ink-ias-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-ias-tricolor').html('-');
                        $('.april-ink-ias-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-ias-actual-target').html('-');
                    $('.april-ink-ias-current-fy-target').html('-');
                    $('.april-ink-ias-current-fy-actual').html('-');
                }
            } else {
            ...
            if(jQuery.inArray(5, datas) != -1) {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-ias-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-ias-actual-target').html(mayDifference);
                        $('.may-ink-ias-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-ias-tricolor').html('-');
                        $('.may-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.may-ink-ias-actual-target').html('-');
                $('.may-ink-ias-tricolor').html('-');
                $('.may-ink-ias-current-fy-target').html('-');
                $('.may-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-ias-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-ias-actual-target').html(juneDifference);
                        $('.june-ink-ias-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-ias-tricolor').html('-');
                        $('.june-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-ias-actual-target').html('-');
                $('.june-ink-ias-tricolor').html('-');
                $('.june-ink-ias-current-fy-target').html('-');
                $('.june-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-ias-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-ias-actual-target').html(julyDifference);
                        $('.july-ink-ias-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-ias-tricolor').html('-');
                        $('.july-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-ias-actual-target').html('-');
                $('.july-ink-ias-tricolor').html('-');
                $('.july-ink-ias-current-fy-target').html('-');
                $('.july-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-ias-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-ias-actual-target').html(augustDifference);
                        $('.august-ink-ias-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-ias-tricolor').html('-');
                        $('.august-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-ias-actual-target').html('-');
                $('.august-ink-ias-tricolor').html('-');
                $('.august-ink-ias-current-fy-target').html('-');
                $('.august-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-ias-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-ias-actual-target').html(septemberDifference);
                        $('.september-ink-ias-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-ias-tricolor').html('-');
                        $('.september-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-ias-actual-target').html('-');
                $('.september-ink-ias-tricolor').html('-');
                $('.september-ink-ias-current-fy-target').html('-');
                $('.september-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-ias-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-ias-actual-target').html(octoberDifference);
                        $('.october-ink-ias-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-ias-tricolor').html('-');
                        $('.october-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-ias-actual-target').html('-');
                $('.october-ink-ias-tricolor').html('-');
                $('.october-ink-ias-current-fy-target').html('-');
                $('.october-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-ias-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-ias-actual-target').html(novemberDifference);
                        $('.november-ink-ias-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-ias-tricolor').html('-');
                        $('.november-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-ias-actual-target').html('-');
                $('.november-ink-ias-tricolor').html('-');
                $('.november-ink-ias-current-fy-target').html('-');
                $('.november-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-ias-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-ias-actual-target').html(decemberDifference);
                        $('.december-ink-ias-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-ias-tricolor').html('-');
                        $('.december-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-ias-actual-target').html('-');
                $('.december-ink-ias-tricolor').html('-');
                $('.december-ink-ias-current-fy-target').html('-');
                $('.december-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-ias-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-ias-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-ias-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-ias-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-ias-tricolor').html('-');
                        $('.january-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-ias-actual-target').html('-');
                $('.january-ink-ias-tricolor').html('-');
                $('.january-ink-ias-current-fy-target').html('-');
                $('.january-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-ias-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-ias-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-ias-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-ias-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-ias-tricolor').html('-');
                        $('.february-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-ias-actual-target').html('-');
                $('.february-ink-ias-tricolor').html('-');
                $('.february-ink-ias-current-fy-target').html('-');
                $('.february-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-ias-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-ias-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-ias-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-ias-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-ias-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-ias-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-ias-tricolor').html('-');
                        $('.march-ink-ias-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-ias-actual-target').html('-');
                $('.march-ink-ias-tricolor').html('-');
                $('.march-ink-ias-current-fy-target').html('-');
                $('.march-ink-ias-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-ias-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-ias-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-ias-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-ias-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-ias-actual-target').html(difference);
            $('.total-ink-ias-tricolor').html(difference);
        } else {
            $('.total-ink-ias-actual-target').html('-');
            $('.total-ink-ias-tricolor').html('-');
            
        }

            $('.april-ink-ias-current-fy').html('April ' + currentYear);
            $('.may-ink-ias-current-fy').html('May ' + currentYear);
            $('.june-ink-ias-current-fy').html('June ' + currentYear);
            $('.july-ink-ias-current-fy').html('July ' + currentYear);
            $('.august-ink-ias-current-fy').html('August ' + currentYear);
            $('.september-ink-ias-current-fy').html('September ' + currentYear);
            $('.october-ink-ias-current-fy').html('October ' + currentYear);
            $('.november-ink-ias-current-fy').html('November ' + currentYear);
            $('.december-ink-ias-current-fy').html('December ' + currentYear);
            $('.january-ink-ias-current-fy').html('January ' + nextYear);
            $('.february-ink-ias-current-fy').html('February ' + nextYear);
            $('.march-ink-ias-current-fy').html('March ' + nextYear); 
        }
    });
}