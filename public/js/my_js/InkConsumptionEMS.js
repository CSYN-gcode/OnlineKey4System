function GetCurrentFYInkDataEMS() {
    $.ajax({
        url: 'get_current_ink_data_ems',
        method: 'get',
        dataType: 'json',
        data: {
            fiscal_year: $('#selFiscalYearInkEMS').val()
        },
        success: function (response) {
                    ...
                    var aprilTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        // console.log('Third IF april');
                         $('.april-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                         aprilTarget = data[datas.findIndex(checkMonth)].target;
                     } else {
                        // console.log('Third ELSE april');
                        $('.april-ink-ems-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.april-ink-ems-actual-target').html(aprilDifference);
                        
                        $('.april-ink-ems-tricolor').html(aprilCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.april-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE april');
                        $('.april-ink-ems-tricolor').html('-');
                        $('.april-ink-ems-current-fy-actual').html('-');
                     }
                } else {
                    // console.log('Second ELSE april');
                    // $('.april-ink-ems-actual-target').html('-');
                    $('.april-ink-ems-current-fy-target').html('-');
                    $('.april-ink-ems-current-fy-actual').html('-');
                }
            } else {
            ...
            if(jQuery.inArray(5, datas) != -1) {
                    ...
                    var mayTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        mayTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.may-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE may');
                        $('.may-ink-ems-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.may-ink-ems-actual-target').html(mayDifference);
                        $('.may-ink-ems-tricolor').html(mayCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.may-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE may');
                        $('.may-ink-ems-tricolor').html('-');
                        $('.may-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.may-ink-ems-actual-target').html('-');
                $('.may-ink-ems-tricolor').html('-');
                $('.may-ink-ems-current-fy-target').html('-');
                $('.may-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(6, datas) != -1) {
                    ...
                    var juneTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        juneTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.june-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE june');
                        $('.june-ink-ems-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.june-ink-ems-actual-target').html(juneDifference);
                        $('.june-ink-ems-tricolor').html(juneCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.june-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE june');
                        $('.june-ink-ems-tricolor').html('-');
                        $('.june-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.june-ink-ems-actual-target').html('-');
                $('.june-ink-ems-tricolor').html('-');
                $('.june-ink-ems-current-fy-target').html('-');
                $('.june-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(7, datas) != -1) {
                    ...
                    var julyTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        julyTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.july-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE july');
                        $('.july-ink-ems-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.july-ink-ems-actual-target').html(julyDifference);
                        $('.july-ink-ems-tricolor').html(julyCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.july-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE july');
                        $('.july-ink-ems-tricolor').html('-');
                        $('.july-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.july-ink-ems-actual-target').html('-');
                $('.july-ink-ems-tricolor').html('-');
                $('.july-ink-ems-current-fy-target').html('-');
                $('.july-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(8, datas) != -1) {
                    ...
                    var augustTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        augustTarget = data[datas.findIndex(checkMonth)].target
                         ...
                         $('.august-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE august');
                        $('.august-ink-ems-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.august-ink-ems-actual-target').html(augustDifference);
                        $('.august-ink-ems-tricolor').html(augustCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.august-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE august');
                        $('.august-ink-ems-tricolor').html('-');
                        $('.august-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.august-ink-ems-actual-target').html('-');
                $('.august-ink-ems-tricolor').html('-');
                $('.august-ink-ems-current-fy-target').html('-');
                $('.august-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(9, datas) != -1) {
                    ...
                    var septemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        septemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.september-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE september');
                        $('.september-ink-ems-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.september-ink-ems-actual-target').html(septemberDifference);
                        $('.september-ink-ems-tricolor').html(septemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.september-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE september');
                        $('.september-ink-ems-tricolor').html('-');
                        $('.september-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.september-ink-ems-actual-target').html('-');
                $('.september-ink-ems-tricolor').html('-');
                $('.september-ink-ems-current-fy-target').html('-');
                $('.september-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(10, datas) != -1) {
                    ...
                    var octoberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        octoberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.october-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE october');
                        $('.october-ink-ems-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.october-ink-ems-actual-target').html(octoberDifference);
                        $('.october-ink-ems-tricolor').html(octoberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.october-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE october');
                        $('.october-ink-ems-tricolor').html('-');
                        $('.october-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.october-ink-ems-actual-target').html('-');
                $('.october-ink-ems-tricolor').html('-');
                $('.october-ink-ems-current-fy-target').html('-');
                $('.october-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(11, datas) != -1) {
                    ...
                    var novemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        novemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.november-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE november');
                        $('.november-ink-ems-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.november-ink-ems-actual-target').html(novemberDifference);
                        $('.november-ink-ems-tricolor').html(novemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.november-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE november');
                        $('.november-ink-ems-tricolor').html('-');
                        $('.november-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.november-ink-ems-actual-target').html('-');
                $('.november-ink-ems-tricolor').html('-');
                $('.november-ink-ems-current-fy-target').html('-');
                $('.november-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(12, datas) != -1) {
                    ...
                    var decemberTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        decemberTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.december-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE december');
                        $('.december-ink-ems-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.december-ink-ems-actual-target').html(decemberDifference);
                        $('.december-ink-ems-tricolor').html(decemberCummulative);
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.december-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE december');
                        $('.december-ink-ems-tricolor').html('-');
                        $('.december-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.december-ink-ems-actual-target').html('-');
                $('.december-ink-ems-tricolor').html('-');
                $('.december-ink-ems-current-fy-target').html('-');
                $('.december-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(1, datas) != -1) {
                 ...
                 if(datas.findIndex(checkMonth) != -1) {
                    ...
                    var januaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        $('.january-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);

                            
                     } else {
                        // console.log('Third ELSE January');
                        $('.january-ink-ems-current-fy-target').html('-');
                     }
                    ...
                    var januaryActual = 0;
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.january-ink-ems-actual-target').html(januaryDifference);
                        ...
                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.january-ink-ems-tricolor').html(januaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.january-ink-ems-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.january-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        $('.january-ink-ems-tricolor').html('-');
                        $('.january-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.january-ink-ems-actual-target').html('-');
                $('.january-ink-ems-tricolor').html('-');
                $('.january-ink-ems-current-fy-target').html('-');
                $('.january-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(2, datas) != -1) {
                    ...
                    var februaryTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        februaryTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.february-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE february');
                        $('.february-ink-ems-current-fy-target').html('-');
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.february-ink-ems-actual-target').html(februaryDifference);

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.february-ink-ems-tricolor').html(februaryCummulative);
                        } else {
                            // console.log('asda');
                            $('.february-ink-ems-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.february-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE february');
                        $('.february-ink-ems-tricolor').html('-');
                        $('.february-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.february-ink-ems-actual-target').html('-');
                $('.february-ink-ems-tricolor').html('-');
                $('.february-ink-ems-current-fy-target').html('-');
                $('.february-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(jQuery.inArray(3, datas) != -1) {
                    ...
                    var marchTarget = 0;
                     if(data[datas.findIndex(checkMonth)].target != null) {
                        ...
                        marchTarget = data[datas.findIndex(checkMonth)].target;
                         ...
                         $('.march-ink-ems-current-fy-target').html(data[datas.findIndex(checkMonth)].target);
                     } else {
                        // console.log('Third ELSE march');
                        $('.march-ink-ems-current-fy-target').html('-');
                     }
                     ...
                     if(data[datas.findIndex(checkMonth)].actual != null) {
                        ...
                        $('.march-ink-ems-actual-target').html(marchDifference); 

                        if(checkCummulative != 'NaN') {
                            // console.log('asd');
                            $('.march-ink-ems-tricolor').html(marchCummulative);
                        } else {
                            // console.log('asda');
                            $('.march-ink-ems-tricolor').html('-');
                        }
                        ...
                        if(data[datas.findIndex(checkMonth)].target > data[datas.findIndex(checkMonth)].actual) {
                         ...
                         $('.march-ink-ems-current-fy-actual').html(data[datas.findIndex(checkMonth)].actual + '&nbsp;&nbsp;&nbsp;&nbsp;' + icon);
                     } else {
                        // console.log('Fourth ELSE march');
                        $('.march-ink-ems-tricolor').html('-');
                        $('.march-ink-ems-current-fy-actual').html('-');
                     }
                ...
                $('.march-ink-ems-actual-target').html('-');
                $('.march-ink-ems-tricolor').html('-');
                $('.march-ink-ems-current-fy-target').html('-');
                $('.march-ink-ems-current-fy-actual').html('-');
            }
            ...
            if(sumTarget != 0 && sumTarget != null) {
                ...
                $('.total-ink-ems-current-fy-target').html(sumTarget); 
            } else {
                $('.total-ink-ems-current-fy-target').html('-'); 
            }
            ...
            if(sumActual != 0 && sumActual != null) {
                ...
                $('.total-ink-ems-current-fy-actual').html(sumActual); 
            } else {
                $('.total-ink-ems-current-fy-actual').html('-'); 
            }
           ...
           if(difference != 0) {
            $('.total-ink-ems-actual-target').html(difference);
            $('.total-ink-ems-tricolor').html(difference);
        } else {
            $('.total-ink-ems-actual-target').html('-');
            $('.total-ink-ems-tricolor').html('-');
            
        }

            $('.april-ink-ems-current-fy').html('April ' + currentYear);
            $('.may-ink-ems-current-fy').html('May ' + currentYear);
            $('.june-ink-ems-current-fy').html('June ' + currentYear);
            $('.july-ink-ems-current-fy').html('July ' + currentYear);
            $('.august-ink-ems-current-fy').html('August ' + currentYear);
            $('.september-ink-ems-current-fy').html('September ' + currentYear);
            $('.october-ink-ems-current-fy').html('October ' + currentYear);
            $('.november-ink-ems-current-fy').html('November ' + currentYear);
            $('.december-ink-ems-current-fy').html('December ' + currentYear);
            $('.january-ink-ems-current-fy').html('January ' + nextYear);
            $('.february-ink-ems-current-fy').html('February ' + nextYear);
            $('.march-ink-ems-current-fy').html('March ' + nextYear); 
        }
    });
}