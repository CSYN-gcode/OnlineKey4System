...
use App\Exports\Sheets\export_action_plan;
...
class Export implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        $sheets[] = new export_action_plan(
            ...
            // $this->water_actual_months,
            // $this->water_mpcount_months,
        ...
        $sheets[] = new export_monitoring(
            ...
            $this->energy_pastfyactual_ave, 
            $this->energy_target_ave,
            $this->energy_actual_ave,
            $this->energy_target_months,
            $this->energy_actual_months,
            $this->water_pasftyactual_ave,
            $this->water_target_ave,
            $this->water_target_sum,
            $this->water_actualmp_ave, //6.1
            $this->water_actual_consumption_ave, //6.2
            $this->water_actual_ave,
            $this->water_target_months,
            $this->water_actual_months,
            $this->water_mpcount_months,
            $this->water_actualpermp_months,
