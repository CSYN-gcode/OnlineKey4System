...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td></td>
        @php
            // $paper_pastfyactual = round($paper_pastfyactual, 2);
            for ($i= 0; $i <= 12; $i++) { 
                echo '<td>'.$paper_pastfyactual.'</td>';
            }
        @endphp
    </tr>
        <!-- END  ROW -->        
            ...
            $paper_pastfy_tricolor_data = array();
                $pastfy_tricolor_ab = $data[0] - $paper_pastfyactual;
                        if ($pastfy_tricolor_ab == 0) {
                            ...
                            $pastfy_tricolor_percentage = 0;
                            echo '<td>'.$pastfy_tricolor_percentage.'%'.'</td>';
                            ...
                            // $pastfy_tricolor_percentage = round($pastfy_tricolor_percentage, 0);
                            echo '<td>'.$pastfy_tricolor_percentage.'%'.'</td>';
                            array_push($paper_pastfy_tricolor_data, $pastfy_tricolor_percentage);
                        }
            ...
            $paper_tricolor_data = array();
                ...
                for ($i=0; $i <= 11; $i++) { 
                    ...
                    if ($tricolor_ab == 0) {
                        ...
                        // $tricolor_percentage = round($tricolor_percentage, 0);
                        echo '<td>'.$tricolor_percentage.'%'.'</td>';
                        array_push($paper_tricolor_data, $tricolor_percentage);
                    }
        ...
        <td></td>
            ...
            @php
                    if ($paper_pastfy_tricolor_data >= 100) {
                            $paper_pastfy_tricolor_data = 100;
                            echo '<td>'.$paper_pastfy_tricolor_data.'%</td>';
                        }
                    else{
                            // $paper_pastfy_tricolor_data = round($paper_pastfy_tricolor_data, 0);
                            echo '<td>'.$paper_pastfy_tricolor_data.'%'.'</td>';
                        }
                ...
                for($i=0; $i <= 11; $i++){
                        ...
                        if ($paper_tricolor_data[$i] >= 100) {
                            ...
                            echo '<td>'.$paper_tricolor_data[$i].'%</td>';
                        }
                        else{
                            // $paper_tricolor_data = round($paper_tricolor_data[$i], 0);
                            echo '<td>'.$paper_tricolor_data[$i].'%'.'</td>';
                        }
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td></td>
        @php
            // $energy_pastfyactual = round($energy_pastfyactual, 1);
            for ($i= 0; $i <= 12; $i++) { 
        ...
        <td></td>
            ...
            @php
                    if ($energy_pastfy_tricolor_data >= 100) {
                            ...
                            // $pastfy_tricolor_percentage = round($energy_pastfy_tricolor_data, 0);
                            echo '<td>'.$pastfy_tricolor_percentage.'%'.'</td>';
                        }
                ...
                for($i=0; $i <= 11; $i++){
                        ...
                        if ($energy_tricolor_data[$i] >= 100) {
                            ...
                            echo '<td>'.$energy_tricolor_data[$i].'%'.'</td>';
                        }
                        else{
                            // $energy_tricolor_data[$i] = round($energy_tricolor_data[$i], 0);
                            echo '<td>'.$energy_tricolor_data[$i].'%'.'</td>';
                        }
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td></td>
        @php
            // $water_pastfyactual = round($water_pastfyactual, 1);
            for ($i= 0; $i <= 12; $i++) { 
    ...
    <tbody>
        ...
        <td></td>
            ...
            @php
                    if ($water_pastfy_tricolor_data >= 100) {
                            $water_pastfy_tricolor_data = 100;
                            echo '<td>'.$water_pastfy_tricolor_data.'%'.'</td>';
                        }
                    else{
                            // $water_pastfy_tricolor_data = round($water_pastfy_tricolor_data, 0);
                            echo '<td>'.$water_pastfy_tricolor_data.'%'.'</td>';
                        }
                ...
                for($i=0; $i <= 11; $i++){
                        ...
                        if ($water_tricolor_data[$i] >= 100) {
                            ...
                            echo '<td>'.$water_tricolor_data[$i].'%</td>';
                        }
                        else{
                            // $water_tricolor_data[$i] = round($water_tricolor_data[$i], 0);
                            echo '<td>'.$water_tricolor_data[$i].'%'.'</td>';
                        }          
                }
            @endphp            
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td>{{ ($paper_pastfy_tricolor_data[0] + $energy_pastfy_tricolor_data[0] + $water_pastfy_tricolor_data[0]) / 3 }}</td>
            {{-- 12 COLUMNS --}}
            @php
    ...
    <tbody>
        <tr>
            ...
            @php
                ...
                array_push($array_sg_paper_target_round, $sg_paper_target[$i]);
                }
                ...
                echo '<td>'.$sg_paper_target_sum.'</td>';
            @endphp
        ...
        <tr>
            ...
            @php
                ...
                array_push($array_sg_paper_actual_round, $sg_paper_actual[$i]);
                }
                for($i= 3; $i <= 11; $i++){
                ...
                echo '<td>'.$sg_paper_actual_sum.'</td>';
            @endphp
        ...
        <tr>
            ...
            for($i= 0; $i <= 2; $i++){
                    ...
                    echo '<td>'.$diff_paper_target_and_actual.'</td>';   
            @endphp
        ...
        <tr>
            ...
            for($i= 0; $i <= 2; $i++){
                ...
                // $tricolor_total = round($tricolor_total, 2);
    ...
    <tbody>
        <tr>
            ...
            @php
                ...
                array_push($array_sg_energy_target_round, $sg_energy_target[$i]);
                }
                ...
                echo '<td>'.$sg_energy_target_sum.'</td>';
        ...
        <tr>
            ...
            @php
                ...
                array_push($array_sg_energy_actual_round, $sg_energy_actual[$i]);
                }
                ...
                echo '<td>'.$sg_energy_actual_sum.'</td>';
            @endphp
        ...
        <tr>
            ...
            for($i= 0; $i <= 2; $i++){
                ...
                echo '<td>'.$diff_energy_target_and_actual.'</td>';   
            @endphp
    ...
    <tbody>
        <tr>
            ...
            @php
                ...
                array_push($array_sg_water_target_round, $sg_water_target[$i]);
                }
                ...
                echo '<td>'.$sg_water_target_sum.'</td>';
            @endphp
        ...
        <tr>
            ...
            @php
                ...
                echo '<td>'.$diff_water_target_and_actual.'</td>';   
            @endphp
