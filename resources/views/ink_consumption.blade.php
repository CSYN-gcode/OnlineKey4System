                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Ink Consumption</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item paperConsumptionSG" style="display: none;">
                                        <a class="nav-link active" id="paper-sg-tab" data-toggle="tab" href="#paper-sg" role="tab" aria-controls="paper-sg" aria-selected="true">Support Group</a>
                                    </li>

                                    <li class="nav-item paperConsumptionTS" id="paperConsumptionTS" style="display: none;">
                                        <a class="nav-link" id="paper-prod-tab" data-toggle="tab" href="#paper-prod" role="tab" aria-controls="paper-prod" aria-selected="false">Production Group</a>
                                    </li>
                                </ul>

                                <div class="tab-content" id="myTabContent">
                                    
                                    <div class="tab-pane fade show active" id="paper-sg" role="tabpanel" aria-labelledby="paper-sg-tab">
                                                ...
                                                <div class="text-left mt-4 d-flex flex-row">
                                                    ...
                                                    <div style="margin-left: auto">
                                                        ...
                                                        <button class="btn btn-primary" data-toggle="modal" data-target="#modalInkTarget"
                                    ...
                                    <div class="tab-pane fade" id="paper-prod" role="tabpanel" aria-labelledby="paper-prod-tab">
                                        ...
                                        <div class="table-responsive" style="overflow: scroll; height: 500px;" >
                                            <table id="tblInkConsumption_prod"
                                                class="table table-md table-bordered table-striped table-hover text-center"
                                                style="width: 100%;">
                                                <thead>
                                                    <tr>
...
@section('js_content')
    ...
    //Reset Modal When Close or Clicked Outside of Modal 
    // $('#modalInkTarget').on('hidden.bs.modal', function () {
    //     $(this).find('form').trigger('reset');
    //         });

    // $('#modalInkConsumption').on('hidden.bs.modal', function () {
    // $('#modalInkConsumption form')[0].reset();
    // });
    ...
    // })
        ...
        $(document).ready(function() {
            ...
            var dataTableInkConsumptions = $("#tblInkConsumption_sg").DataTable({
                "processing": false,
                "serverSide": true,
                // "responsive": true,
                // "scrollY": true,
            ...
            //===== DATATABLES OF ENERGY CONSUMPTION ================
            var dataTableInkConsumptions = $("#tblInkConsumption_prod").DataTable({
                "processing": false,
                "serverSide": true,
                // "responsive": true,
                // "scrollY": true,
            ...
            $("#tblInkConsumption_sg").on('click', '.actionEditInkConsumptionTarget', function() {
            ...
            //===== EDIT INK CONSUMPTION TARGET =====
            $("#tblInkConsumption_prod").on('click', '.actionEditInkConsumptionTarget', function() {
                let id = $(this).attr('ink-id');
            ...
            $('#tblInkConsumption_sg').on('click', '.actionAddInkConsumption', function() {
                let id = $(this).attr('ink-id');
            ...
            //===== ADD NEW INK ACTUAL CONSUMPTION  =====
            $('#tblInkConsumption_prod').on('click', '.actionAddInkConsumption', function() {
                let id = $(this).attr('ink-id');
            ...
            $('#tblInkConsumption_sg').on('click', '.actionEditInkConsumption', function() {
                let id = $(this).attr('ink-id');
            ...
            //===== EDIT INK ACTUAL CONSUMPTION =====
            $('#tblInkConsumption_prod').on('click', '.actionEditInkConsumption', function() {
                let id = $(this).attr('ink-id');
