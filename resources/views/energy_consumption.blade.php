            ...
            <div class="modal-content">
                ...
                <form id="formAddEnergyActual">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" id="btnAddEnergyConsumption" class="btn btn-primary"><i
                                id="iBtnAddEnergyConsumptionIcon" class="fa fa-check"></i> Save</button>
                    </div>
                </form>
            </div>
        </div>
