                                                        ...
                                                        <td align="left"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span style="font-size: 12px;">Good morning!</span>
                                                                </p>
                                                                <p
                                                                    style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                    <span style="font-size: 12px;">Please be reminded
                                                                        that the month is ending and you need to
                                                                        <strong>UPDATE</strong> your department's Monthly Resources
                                                                        Consumption for the month</span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                    You can access the system by clicking the button
                                                                    below&nbsp;</p>
                                                            </div>
