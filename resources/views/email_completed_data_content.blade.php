          ...
          <![endif]-->
                                            ...
                                            <div class="mj-column-per-100 outlook-group-fix"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            style="font-size:0px;padding:15px 99px 0px 15px;word-break:break-word;">
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span style="font-size: 16px;"><strong>Good morning!</strong></span>
                                                                </p>
                                                                <p
                                                                    style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                    <span style="font-size: 15px;"><strong>Please be informed
                                                                        that all data for this month is completed and ready for report extraction</strong></span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td
                                                            style="background:#FFFFFF;font-size:0px;padding:10px 0px;padding-top:10px;word-break:break-word;">
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <div
                                                                ...
                                                                {{-- <p
                                                                    style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                    <span style="font-size: 12px;">If there is no
                                                                        consumption for the month just insert
                                                                        "0" consumption then just press the save button.
                                                                        &nbsp;
                                                                        &nbsp;</span>
                                                                </p>
                                                                <p
                                                                ...
                                                                <p
                                                                    style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                    Note: You must update all your monthly resources consumptions
                                                                    even when there is no consumption for the
                                                                    month.&nbsp;</p>
                                                                <p
                                                                    style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                    &nbsp;</p> --}}
                                                                <p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                    <span style="font-size: 16px;"><strong>You can access the system by clicking the button
                                                                        below&nbsp;</strong></span>
                                                                </p>
                                                            </div>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center" bgcolor="#181818"
                                                                        role="presentation"
                                                                        style="border:none;border-radius:24px;cursor:auto;mso-padding-alt:9px 26px 9px 26px;background:#181818;"
                                                                        valign="middle">
                                                                        <a href="http://rapidx/okfms/"
                                                                            style="display: inline-block; background: #181818; color: #ffffff; font-family: Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif; font-size: 13px; font-weight: normal; line-height: 100%; margin: 0; text-decoration: none; text-transform: none; padding: 9px 26px 9px 26px; mso-padding-alt: 0px; border-radius: 24px;"
                                                                            target="_blank">
                                                                            Key-4 Monitoring System
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
